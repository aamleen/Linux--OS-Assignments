...
/*This program follows the same logic as in part a of same question 1.
 The only difference is that here we take the input of no. of rows, and no. of columns in each rows, by user*/
...
int main()
{
    ...
    printf("Enter no. of columns for each row: ");
    int col[rows];
    for(i=0;i<rows;i++)
